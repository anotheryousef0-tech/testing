...
const RedNick = {
    onLoad: () => {
        // Plugin by Wpee2L
        RedNick.unregister = commands.registerCommand({
            name: "setnickname",
            ...
            execute: (args, ctx) => {
                ...
                return { content: "Wpee2L System: Local nickname saved." };
            }
        });

        RedNick.unpatch = patcher.after("default", MessageHeader, ([{ message }], res) => {
